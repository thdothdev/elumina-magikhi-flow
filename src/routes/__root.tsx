...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Mágikhi × Elumina IA — Ecossistema de Inteligência Operacional" },
      { property: "og:description", content: "Proposta comercial: IA para triagem de sinistros, base cadastral única e portal financeiro em 21 dias." },
